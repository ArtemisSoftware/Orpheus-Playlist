package com.artemissoftware.orpheusplaylist.presentation.composables.album
...
@Composable
private fun AlbumCover(track: Audio) {
    val painter = rememberAsyncImagePainter(
        model = ImageRequest.Builder(LocalContext.current)
            .data(track.albumCover)
            .size(Size.ORIGINAL)
